/** Tunable balance knobs for the lap engine (v1). Not final balance. */
...
/** Fuel: seconds-equivalent mass cost per kg, applied as time mult via base. */
export const FUEL_KG_TIME_FACTOR = 0.00035; // per kg vs empty, as mult addon
...
/** Soft/Med/Hard cliff life thresholds (design-decisions). */
...
export const TIRE_TEMP_WINDOW = 15; // ±°C before grip falls off

/** Cliff: extra time mult when below threshold (scales with how far under). */
export const CLIFF_PENALTY_K = 0.9;

/** Moisture vs compound grip mult. */
export const MOISTURE_COMPOUND: Record<
	string,
...
export const DIRTY_AIR_PENALTY_K = 0.06; // time mult addon at dirtyAir=1
export const DAMAGE_PENALTY_K = 0.2; // at damageFactor=0
